    ...
    return (
        <div>
            ...
            <main className='mx-10 start-page rounded-xl p-5 pb-10'>
                <h1 className='text-white text-3xl font-bold text-center mt-5'>Java Full Stack Development</h1>
                <div className='flex justify-center'>
                    <p className='text-white text-md mt-7 w-[60%]'>A Java full-stack development course typically covers both front-end and back-end development using Java as the primary programming language. The course includes a range of technologies and tools needed to build complete web applications.</p>
                </div>
                ...
                <p className='text-lg text-white'>Any student who wants to learn Java Full Stack from scratch</p>
                <Link to={'/java/videos1'}>
