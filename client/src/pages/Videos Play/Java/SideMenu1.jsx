    ...
    <aside className="md:flex md:flex-col hidden w-[25%] max-md:ml-0 max-md:w-full" style={{ borderRight: "solid 3px white" }}>
      <div className="flex flex-col mt-1.5 w-full max-md:mt-10">
        ...
        <div className="flex flex-col pl-3 w-full">
          ...
          <div className="text-lg bg-stone-100 p-1 flex gap-4 self-start mt-6 ml-6 text-black">
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/a2e9dd1178c5ca015e8170e201df331a8e007d306d5404c2d4d178c4e75fb307?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" alt="" className="object-contain shrink-0 self-start mt-5 aspect-square w-[30px]" />
            <div>Introduction to<br />Java Programming</div>
          </div>
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="What is Java ?" duration="7 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="What is Java Full Stack?" duration="6 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="Frontend Development" duration="17 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="Backend Development" duration="22 min" />
        </div>
        ...
        <div className="flex gap-4 self-start ml-14 mt-2 max-w-full text-xl font-medium text-stone-100 w-full cursor-pointer" onClick={()=>{alert("Complete all the videos to attend the quiz")}}>
