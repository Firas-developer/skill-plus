    ...
    <aside className="md:flex md:flex-col hidden w-[25%] max-md:ml-0 max-md:w-full" style={{ borderRight: "solid 3px white" }}>
      <div className="flex flex-col mt-1.5 w-full max-md:mt-10">
        ...
        <div className="flex flex-col pl-3 w-full">
          ...
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/3b68a29bf50c8648e726f65f1156f7f874ef94c15d87f1de5143b81c0fd38e44?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="What is Java Full Stack?" duration="6 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/a2e9dd1178c5ca015e8170e201df331a8e007d306d5404c2d4d178c4e75fb307?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="Frontend Development" duration="17 min" isActive={true} />
