      ...
      <div className="flex flex-col mt-1.5 w-full max-md:mt-10">
        ...
        <div className="flex flex-col pl-3 w-full">
          ...
          <div className="text-lg bg-stone-100 p-1 flex gap-4 self-start mt-6 ml-6 text-black">
            ...
            <div>Introduction to<br />.NET core</div>
          </div>
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text=".NET Installation Guide" duration="5 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="Gen AI in .NET" duration="5 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="Update your pakage with .NET" duration="6 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="What is new in .NET" duration="9 min" />
        </div>
