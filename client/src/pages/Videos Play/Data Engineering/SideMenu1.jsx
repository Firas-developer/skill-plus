    ...
    <aside className="md:flex md:flex-col hidden w-[25%] max-md:ml-0 max-md:w-full" style={{borderRight:"solid 3px white"}}>
      <div className="flex flex-col mt-1.5 w-full max-md:mt-10">
        ...
        <div className="flex flex-col pl-3 w-full">
          ...
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="What is Data Streaming" duration="5 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="Pillars of Data Engineering" duration="5 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="ELT vs ETL" duration="6 min" />
          <MenuItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/cc011f60899c3ac4c96ff9ce61c7fb6f39e2909300df2b5370cf2df6e909cf57?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" text="Deploy Data projects" duration="9 min" />
        </div>
