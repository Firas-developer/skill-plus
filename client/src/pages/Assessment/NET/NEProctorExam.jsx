          ...
          <div className="flex gap-5 max-md:flex-col">
            <div className="flex flex-col w-full max-md:ml-0 max-md:w-full">
              <div className="flex z-10 flex-col w-full text-lg font-bold text-white max-md:max-w-full">
                ...
                <ProctorSteps />
                <button onClick={() => { navigate('/net/test') }} className="hidden md:block self-center md:ml-[50%] px-16 py-4 my-20 mr-6 text-3xl whitespace-nowrap bg-sky-400 rounded-3xl max-md:px-5 max-md:mt-10 max-md:mr-2.5">
                  Start
                </button>
