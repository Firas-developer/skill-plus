    ...
    return (
        <div>
            ...
            <main className='mx-10 start-page rounded-xl p-5 pb-10'>
                <h1 className='text-white text-3xl font-bold text-center mt-5'>.NET Development</h1>
                <div className='flex justify-center'>
                    <p className='text-white text-md mt-7 w-[60%]'>A .NET Development certainly includes C# programming language for backend functions which involves various operation such as CRUD opoerations</p>
                </div>
                ...
                <p className='text-lg text-white'>Any student who wants to learn .NET development from scratch</p>
                <Link to={'/net/videos1'}>
