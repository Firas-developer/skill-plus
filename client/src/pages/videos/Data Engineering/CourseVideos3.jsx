...
const videos = [
  { title: 'What is Data Engineering', duration: '5 min', type: 'Video', link: "/dataEngineering/videosplay1" },
  { title: 'What is Data Streaming', duration: '5 min', type: 'Video' },
  { title: 'Pillars of Data Engineering', duration: '5 min', type: 'Video' },
  { title: 'ELT vs ETL', duration: '8 min', type: 'Video' },
  { title: '3 ways to Deploy Data projects', duration: '9 min', type: 'Video' },
];
  ...
  return (
    <section className="flex flex-col items-start max-w-full w-[94%]">
      ...
      {videos.slice(2).map((video, index) => (
        <Link to={'/dataEngineering/videosplay3'}><div className='w-full'><VideoItem key={index + 2} {...video} isFirst={false} /></div></Link>
      ))}
    </section>
  );
}
