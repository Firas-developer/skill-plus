    ...
    const batches = [
        {
            ...
            description: "Java Full Stack course which includes Springboot framework for the backend functions",
            logo: FullStack,
            navigate: "/java"
        },
    ]
    return (
        <div>
            ...
            <main className='mx-10 start-page rounded-xl font-semibold p-5 md:h-[600px]'>
                <h1 className='text-white text-3xl p-3'>Java Batch</h1>
