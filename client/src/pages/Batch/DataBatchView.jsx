    ...
    const batches = [
        {
            ...
            description: "The field of data engineering is concerned with designing and maintaining the support systems",
            logo: DataEngineering,
            size: "md:w-[60%]",
            navigate: "/dataEngineering"
        }
    ]
    return (
        <div>
            ...
            {/* Batch Section */}
            <main className='mx-10 start-page rounded-xl font-semibold p-5 md:h-[600px]'>
                <h1 className='text-white text-3xl p-3'>Data Engineering Batch</h1>
                <div className='w-[100%] flex flex-col gap-10 md:gap-0 md:flex-row items-center justify-around mt-10'>
                    {
                        batches.map((batch) => {
                            return (
                                <div className='md:w-[30%] w-full hover:shadow-black hover:shadow-xl' onClick={() => { navigate(batch.navigate) }}>
                                    <div className='bg-[#F6F4EB] w-full md:flex md:justify-center'>
                                        <img src={batch.logo} alt="" className={batch.size} />
                                    </div>
                                    <div className='p-3'>
                                        <h1 className='md:text-2xl text-white font-bold md:my-5'>{batch.course}</h1>
                                        <p className='text-white text-sm md:text-md'>{batch.description}</p>
                                    </div>
                                </div>
                            )
                        })
